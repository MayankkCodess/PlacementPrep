  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex">
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-teal-500/20 via-cyan-500/10 to-pink-500/20" />
        <div className="absolute inset-0 backdrop-blur-3xl" />
        <div className="relative z-10 flex flex-col justify-center items-center p-12 text-white">
          <div className="space-y-8 max-w-md">
            <div className="space-y-4">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-teal-500 to-cyan-600 shadow-lg shadow-teal-500/50">
            ...
            <div className="space-y-6 pt-8">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Lightning-fast access to your account</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
            ...
            <div className="pt-8">
              <div className="grid grid-cols-3 gap-4">
                <div className="h-1 bg-gradient-to-r from-teal-500 to-cyan-500 rounded-full" />
      ...
      {/* Main Code Starts Here Above is Just a Side View */}
          ...
          <CardContent className="pt-8 pb-8 px-8">
            <div className="space-y-6">
              ...
              <form className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-10 bg-[#0a0a0a] border-gray-700 text-white placeholder:text-gray-600 focus:border-teal-500 focus:ring-teal-500/20"
                      required
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      placeholder="••••••••"
                      className="pl-10 pr-10 bg-[#0a0a0a] border-gray-700 text-white placeholder:text-gray-600 focus:border-teal-500 focus:ring-teal-500/20"
                      required
                    />
                    <button
                      type="button"
                ...
                <div className="flex items-center justify-between text-sm">
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      type="checkbox"
                      className="w-4 h-4 rounded border-gray-700 bg-[#0a0a0a] text-teal-500 focus:ring-teal-500 focus:ring-offset-0"
                    />
                ...
                <Button
                  type="submit"
                  className="w-full h-11 bg-gradient-to-r from-teal-500 to-cyan-600 hover:from-teal-600 hover:to-cyan-700 text-white font-semibold shadow-lg shadow-teal-500/30 transition-all duration-200"
                >
                  Sign In
                </Button>
              </form>
              ...
              <p className="text-center text-sm text-gray-400">
                ...
                <a href="/signup" className="text-teal-400 hover:text-teal-300 font-semibold transition-colors">
                  Sign up
                </a>
              </p>
            </div>
